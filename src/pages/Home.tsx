  ...
  return (
      <div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10, padding:"0 20px" }}>
          <StatCard label="Earned today" value={dashQ.isLoading ? null : fmt.currency(stats.todayRevenue ?? 0)} primary />
          <StatCard label="This week"    value={dashQ.isLoading ? null : fmt.currency(stats.weeklyTotal ?? 0)} />
          <StatCard label="Pending deposits" value={dashQ.isLoading ? null : String(stats.pendingDeposits ?? 0)} alert={(stats.pendingDeposits ?? 0) > 0} />
